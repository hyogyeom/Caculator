...
#set_property -dict { PACKAGE_PIN V2   IOSTANDARD LVCMOS33 } [get_ports { i_digitSelect[0]  }]; #IO_L5P_T0_34               ,Sch=SW8
#set_property -dict { PACKAGE_PIN T3   IOSTANDARD LVCMOS33 } [get_ports { i_digitSelect[1]  }]; #IO_L2N_T0_34               ,Sch=SW9
